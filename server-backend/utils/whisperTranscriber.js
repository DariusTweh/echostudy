...
export async function transcribeAudio(inputPath) {
  ...
  console.log('🛠️ FFmpeg command: ffmpeg -i', inputPath, '-y -f mp3', outputPath);
  ...
  try {
    ...
    // 💬 TEMPORARILY DISABLED FILE DELETION for debugging
    // To clean up later, re-enable these lines:
    /*
